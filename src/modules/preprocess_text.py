...
def preprocess_text(text_list, punctuation=puncts, stopwords=engStopWords, lemmatizer=lemmatizer):
    """
    Combines previous functions to preprocess text
    Uses regex for more cleaning
